...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "81f71d91-e01b-41ec-ae27-70cbdeebcfc0"
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\ceohi\\OneDrive\\Documents\\projects\\minimal-nuxt-app\\.data\\kv"}));
...
const _lazy_B1F8wo = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_B1F8wo, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_B1F8wo, lazy: true, middleware: false, method: undefined }
];
