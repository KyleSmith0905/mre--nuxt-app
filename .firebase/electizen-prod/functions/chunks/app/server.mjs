import { version, ref, watchEffect, watch, getCurrentInstance, hasInjectionContext, unref, inject, useSSRContext, createApp, effectScope, reactive, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, h, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'vue';
import { d as useRuntimeConfig$1, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, $ as $fetch, n as sanitizeStatusCode, o as createHooks, q as isEqual, r as stringifyParsedURL, t as stringifyQuery, v as parseQuery } from '../nitro/node.mjs';
...
const unhead_4DbdV6KkHQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_XZ7OSEXXWD = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_EatAJtFFOf = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_4DbdV6KkHQ,
  router_XZ7OSEXXWD,
  revive_payload_server_EatAJtFFOf,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-43c3c609.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-a72b94c3.mjs').then((r) => r.default || r));
